...
const hexBloodFavour = new Perk("Hex: Blood Favour", "killerimgs/Teachable_hexBloodFavour.png", "Hitting a Survivor with either your Basic Attack or Special Attack prompts The Entity to hold all Pallets within a radius of 24/28/32 metres from your location in place for the next 15 seconds, preventing Survivors from pulling them down. The Hex effects persist as long as the related Hex Totem is standing.")
...
const hexRetribution = new Perk("Hex: Retribution", "killerimgs/Teachable_hexRetribution.png", "Survivors cleansing any Totem suffer from the Oblivious Status Effect for 35/40/45 seconds. After cleansing a Hex Totem, the Auras of all Survivors are revealed to you for 15 seconds.")
...
const hexUndying = new Perk("Hex: Undying", "killerimgs/Teachable_hexUndying.png", "The Auras of Survivors within 2/3/4 metres of any Dull Totem are revealed to you. When another Perk's Hex Totem is cleansed, its Hex is transferred to the Hex: Undying Totem, including any accumulated Tokens, disabling Hex: Undying instead." )
...
const Jolt = new Perk("Jolt", "killerimgs/Teachable_surge.png", "When you put a Survivor into the Dying State with your Basic Attack, all Generators within 32 metres of you instantly explode and start regressing. Applies an immediate 8 % Progression penalty. Jolt has a cool-down of 60/50/40 seconds.")
...
const Lightborn = new Perk("Lightborn", "killerimgs/Teachable_lightborn.png", "The Auras of Survivors attempting to blind you with a Flashlight are revealed to you for 6/8/10 seconds. Lightborn grants immunity from being blinded by Flashlights, Firecrackers, Flashbangs, or Blast Mines.")
...
const Whispers = new Perk("Whispers", "killerimgs/IconPerks_whispers.png", "Sporadically hear the whispers of The Entity when a Survivor is within 48/40/32 metres of your location.")
